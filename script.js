function openGift() {
    ...
    newWindow.document.write(`
      <html>
      <head>
        <title>¡Feliz Cumpleaños Mi Profe!</title>
        <style>
          body {
      ...
      <body>
        <h1>¡Feliz Cumpleaños, Mi profe Hermosa!</h1>
        <div class="lyrics">
          ...
          <p>Te amo mucho gorda, deseo mucho que pasemos muchos cumpleaños juntos, deseo este día sea para ti lleno de felicidad, quiero ser parte de tu vida para llegar a la cima juntos</p>
          <h2>Sigue creciendo mi amor, no te detengas nunca, el exito te espera!!</h2>
          <h1>FELIZ CUMPLEAÑOS MI AMOR</h1>
          <h1>FELIZ CUMPLEAÑOS MI DORMILONA</h1>
          <h1>FELIZ CUMPLEAÑOS MI PROFE</h1>
          <h1>FELIZ CUMPLEAÑOS MI GORDITA</h1>
          <h8>Con mucho amor, atentamente tu gordito</h8>
        </div>
        <img id="Bebitos" src="/Bebitos.jpg" alt="bebitos">
  ...
  const countdownInterval = setInterval(() => {
    ...
    if (distance <= 0) {
      ...
      document.getElementById("message").textContent = "¡ABra sU RegAlo Profe!";
